...
class SBMessageInputView: UIView {
    ...
    @IBInspectable var textViewLeftInset: CGFloat = 0.0 {
        didSet {
    ...
    var buttonViewHeight: CGFloat = 0.0
    ...
    fileprivate func setContainerView() {
        ...
        let leadingConstraint = NSLayoutConstraint(item: mainView, attribute: .leading, relatedBy: .equal, toItem: self, attribute: .leading, multiplier: 1, constant: 5.0)
        let trailingConstraint = NSLayoutConstraint(item: self, attribute: .trailing, relatedBy: .equal, toItem: mainView, attribute: .trailing, multiplier: 1, constant: 5.0)
        let topConstraint = NSLayoutConstraint(item: mainView, attribute: .top, relatedBy: .equal, toItem: self, attribute: .top, multiplier: 1, constant: 0)
        let bottomConstraint = NSLayoutConstraint(item: self, attribute: .bottom, relatedBy: .equal, toItem: mainView, attribute: .bottom, multiplier: 1, constant: 0)
...
extension SBMessageInputView: UITextViewDelegate {
    ...
    func textViewDidChange(_ textView: UITextView) {
        ...
        let lines = Darwin.round((textView.contentSize.height - textView.textContainerInset.top - textView.textContainerInset.bottom) / fontLineHeight)
